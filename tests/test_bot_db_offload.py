...
class BotDbOffloadTests(unittest.TestCase):
    ...
    def test_update_ingress_logs_callback_safely_and_allows_callback_handler(self):
        ...
        self.assertNotIn('telegram_user_id=', logged)
    ...
    def test_answer_and_next_callbacks_emit_secret_safe_handler_start_logs(self):
        ...
        self.assertNotIn("telegram_user_id=", joined)
    ...
    def test_main_registers_imported_classic_quiz_handlers_and_patterns(self):
        ...
        expected_patterns = [
            ...
            r'^cat:\d+$',
            r'^qcnt:\d+:(5|10|15|all|choose)$',
            r'^qmode:\d+:(5|10|15|all|choose):(any|easy|medium|hard)$',
            r'^qcntall:(5|10|15|all|choose)$',
            r'^qmodeall:(5|10|15|all|choose):(any|easy|medium|hard)$',
