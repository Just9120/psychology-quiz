...
- постоянная reply keyboard в private chat (`🎯 Начать викторину`, `ℹ️ Помощь`, `👁 Режим чтения`, `🙈 Скрыть меню`)
- ручное скрытие reply keyboard кнопкой `🙈 Скрыть меню` с отдельным сообщением восстановления через inline-кнопку `👁 Показать меню` и fallback через `/start`
...
- persistent пользовательская настройка режима чтения (`Обычный` / `Бионическое чтение`) с мягким bionic-акцентом
