...
- сценарий викторины на серию вопросов по выбранной категории (до 5 за сессию)
...
- `/quiz` — запуск викторины: выбор категории → сессия до 5 вопросов без повторов → итоговый результат
